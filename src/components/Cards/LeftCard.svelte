<script>
  ...
  import UserCardDetails from "@components/Cards/UserCardDetails.svelte";
...
<div class="bg-white shadow-sm rounded-lg p-2 sm:p-6 border border-gray-200">
  <div class="grid grid-cols-12 gap-4">
    ...
    {/if}
    <div
      class="col-span-12 {userDetails.userProfileUrl ? 'lg:col-span-8' : ''}"
    >
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 items-start">
        ...
        <div class="space-y-4 text-gray-700">
          ...
          <div>
            <span class="text-sm font-normaltext-gray-500"
